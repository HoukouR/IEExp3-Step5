...
public class CommunicationTask5 extends AsyncTask<Void, String, Void> {
    /** サーバのIPアドレス */
    ...
    private CommunicationTask5Callback callback;

    public CommunicationTask5(String address, int port, CommunicationTask5Callback callback) {
